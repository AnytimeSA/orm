...
class PostgreSqlTableStructureRetrieverTest extends TestCase
{
        ...
        $this->assertSame(
            [
                'id' => [
                    ...
                    'allowNull' => false,
                    'keyType' => null,
                    'defaultValue' => "nextval('random_table_id_seq'::regclass)",
                    'dateFormat' => ''
                ],
                'name' => [
                    'tableName' => 'random_table',
    ...
    public function getGetStructureAllCases()
    {
        ...
        return [
            ['numeric', 'NO', 0.0, 'float', false, 0.0, ''],
            ['float4', 'NO', 0.0, 'float', false, 0.0, ''],
            ['float8', 'NO', 0.0, 'float', false, 0.0,  ''],
            ['double precision', 'NO', 0.0, 'float', false, 0.0, ''],
            ['real', 'NO', 0.0, 'float', false, 0.0, ''],
            ['numeric', 'NO', null, 'float', false, null, ''],
            ['numeric', 'YES', null, 'float', true, null, ''],
            ['numeric', 'YES', 0.0, 'float', true, 0.0, ''],
            ['bit', 'NO', "'0'::\"bit\"", 'bool', false, "'0'::\"bit\"", ''],
            ['bit', 'YES', "'0'::\"bit\"", 'bool', true, "'0'::\"bit\"", ''],
            ['bit', 'NO', null, 'bool', false, null, ''],
            ['bool', 'NO', false, 'bool', false, false, ''],
            ['bool', 'YES', false, 'bool', true, false, ''],
            ['bool', 'NO', true, 'bool', false, true, ''],
            ['bool', 'YES', true, 'bool', true, true, ''],
            ['bool', 'NO', null, 'bool', false, null, ''],
            ['bool', 'YES', null, 'bool', true, null, ''],
            ['boolean', 'NO', false, 'bool', false, false, ''],
            ['varbit', 'YES', 10, 'int', true, 10, ''],
            ['bit varying', 'YES', 10, 'int', true, 10, ''],
            ['smallint', 'YES', 10, 'int', true, 10, ''],
            ['int2', 'YES', 10, 'int', true, 10, ''],
            ['int', 'YES', 10, 'int', true, 10, ''],
            ['integer', 'YES', 10, 'int', true, 10, ''],
            ['int4', 'YES', 10, 'int', true, 10, ''],
            ['bigint', 'YES', 10, 'int', true, 10, ''],
            ['int8', 'YES', 10, 'int', true, 10, ''],
            ['smallserial', 'YES', 10, 'int', true, 10, ''],
            ['serial2', 'YES', 10, 'int', true, 10, ''],
            ['serial', 'YES', 10, 'int', true, 10, ''],
            ['serial4', 'YES', 10, 'int', true, 10, ''],
            ['bigserial', 'YES', 10, 'int', true, 10, ''],
            ['serial8', 'YES', 10, 'int', true, 10, ''],
            ['varbit', 'NO', 10, 'int', false, 10, ''],
            ['bit varying', 'NO', 10, 'int', false, 10, ''],
            ['smallint', 'NO', 10, 'int', false, 10, ''],
            ['int2', 'NO', 10, 'int', false, 10, ''],
            ['int', 'NO', 10, 'int', false, 10, ''],
            ['integer', 'NO', 10, 'int', false, 10, ''],
            ['int4', 'NO', 10, 'int', false, 10, ''],
            ['bigint', 'NO', 10, 'int', false, 10, ''],
            ['int8', 'NO', 10, 'int', false, 10, ''],
            ['smallserial', 'NO', 10, 'int', false, 10, ''],
            ['serial2', 'NO', 10, 'int', false, 10, ''],
            ['serial', 'NO', 10, 'int', false, 10, ''],
            ['serial4', 'NO', 10, 'int', false, 10, ''],
            ['bigserial', 'NO', 10, 'int', false, 10, ''],
            ['serial8', 'NO', 10, 'int', false, 10, ''],
            ['serial8', 'NO', null, 'int', false, null, ''],
            ['date', 'NO', null, 'date', false, null, 'Y-m-d'],
            ['timestamptz', 'NO', null, 'date', false, null, 'Y-m-d H:i:s.u P'],
            ['timetz', 'NO', null, 'date', false, null, 'H:i:s.u P'],
            ['time', 'NO', null, 'date', false, null, 'H:i:s.u'],
            ['timestamp', 'NO', null, 'date', false, null, 'Y-m-d H:i:s.u'],
            ['time with time zone', 'NO', null, 'date', false, null, 'H:i:s.u P'],
            ['time without time zone', 'NO', null, 'date', false, null, 'H:i:s.u'],
            ['timestamp with time zone', 'NO', null, 'date', false, null, 'Y-m-d H:i:s.u P'],
            ['timestamp without time zone', 'NO', null, 'date', false, null, 'Y-m-d H:i:s.u'],
            ['timestamp without time zone', 'YES', null, 'date', true, null, 'Y-m-d H:i:s.u'],
            ['timestamp without time zone', 'YES', '2020-11-01 14:11:54.000000 +00:01', 'date', true, '2020-11-01 14:11:54.000000 +00:01', 'Y-m-d H:i:s.u']
        ];
    }
}
